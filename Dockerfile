...
RUN cd tools && git clone https://github.com/radare/radare2 && cd radare2 && sys/install.sh
#RUN git clone https://github.com/niklasb/libc-database && cd libc-database && ./get
